...
namespace oneparalyzer.LeasingSystem.Employees.Infrastructure.Migrations
{
    ...
    [Migration("20230503143354_Comapany-Initial")]
    partial class ComapanyInitial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("oneparalyzer.LeasingSystem.Employees.Domain.AggregateModels.DepartmentAggregate.Department", b =>
                {
                    b.OwnsMany("oneparalyzer.LeasingSystem.Employees.Domain.AggregateModels.PostAggregate.ValueObjects.PostId", "PostIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("oneparalyzer.LeasingSystem.Employees.Domain.AggregateModels.OfficeAggregate.Office", b =>
                {
                    ...
                    b.OwnsMany("oneparalyzer.LeasingSystem.Employees.Domain.AggregateModels.DepartmentAggregate.ValueObjects.DepartmentId", "DepartmentIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
